...
\MathematicalDescription{
  ...
  \end{itemize}
    ...
    \Example{
      ...
      \begin{center}
        \includegraphics[width=0.50\textwidth]{Figures/oversmoothing.pdf}
      \end{center}
      ...
      \begin{center}
        \includegraphics[width=0.60\textwidth]{Figures/undersmoothing.pdf}
      \end{center}
      ...
      \begin{center}
        \includegraphics[width=0.50\textwidth]{Figures/OKsmoothing.pdf}
      \end{center}
