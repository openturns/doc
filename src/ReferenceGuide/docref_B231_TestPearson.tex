...
\MathematicalDescription{
  ...
  This method deals with the modelling of a probability distribution of a random vector $\vect{X} = \left( X^1,\ldots,X^{n_X} \right)$. It seeks to find a type of dependency (here a linear correlation) which may exist between two components $X^i$ and $X^j$. \vspace{2mm}
  ...
  \begin{center}
    \includegraphics[width=0.5\textwidth]{Figures/pearson2.pdf}
  \end{center}
