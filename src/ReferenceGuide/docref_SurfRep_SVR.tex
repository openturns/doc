...
\MathematicalDescription{
  ...
  \begin{itemize}
  \item \textbf{Step no. 1} \\ Choice of the type of kernel (rbf, polynomial,...) caracterized by a set of parameters.
  \item \textbf{Step no. 2} \\ Estimate the best set of parameters through cross-validation.
  \item \textbf{Step no. 3} \\ Estimation of the parameters of the response surface by a finite number of computations.
  \end{itemize}

  Within this file, we are dealing with the steps no. 1 and 2.
