...
For the practical side i.e. the use of these functions in OpenTURNS Textual User Interface, the User is refered to the \otrefext{OpenTURNS_UseCasesGuide}{TUI Use Cases Guide}.
