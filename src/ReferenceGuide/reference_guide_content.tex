...
\extanchor{stepB}
\section{OpenTURNS' methods for Step B: quantification of the uncertainty sources}
...
\item \otref{docref_B21_BayesianCalibration}{Bayesian Calibration} -- see page \pageref{docref_B21_BayesianCalibration}
...
\input{docref_B11_EmpiricalCDF.tex}
\newpage
\input{docref_B11_KernelSmoothing.tex}
\newpage
\input{docref_B121_DistributionSelection.tex}
\newpage
\input{docref_B122_Copulas.tex}
\newpage
\input{docref_B122_RandomMixture.tex}
\newpage
\input{docref_B201_Graph.tex}
\newpage
\input{docref_B202_Smirnov.tex}
\newpage
\input{docref_B21_MaximumLikelihood.tex}
\newpage
\input{docref_B21_BayesianCalibration.tex}
\newpage
\input{docref_B21_MetropolisHastings.tex}
\newpage
\input{docref_B21_ParametricEstimation.tex}
\newpage
\input{docref_B221_Graph.tex}
\newpage
\input{docref_B222_TestChi2.tex}
\newpage
\input{docref_B222_TestKS.tex}
\newpage
\input{docref_B222_TestCVM.tex}
\newpage
\input{docref_B222_TestAD.tex}
\newpage
\input{docref_B222_BayesianInformationCriterion.tex}
\newpage
%\input{docref_B223_Bootstrap.tex}
\newpage
\input{docref_B231_Pearson.tex}
\newpage
\input{docref_B231_TestPearson.tex}
\newpage
\input{docref_B232_Spearman.tex}
\newpage
\input{docref_B232_TestSpearman.tex}
\newpage
\input{docref_B233_TestChi2.tex}
\newpage
\input{docref_B234_LinearRegression.tex}
\newpage
...
\begin{itemize}
\item an  design of experiments  which can be deterministic or probabilistic : \otref{docref_C11_ExperimentPlanes}{Design of Experiments } -- see page \pageref{docref_C11_ExperimentPlanes}
...
\input{docref_C_UniformRandomGenerator}
\newpage
\input{docref_C_DistributionRealisations}
\newpage
\input{docref_C_LowDiscrepancySequence}
\newpage
\input{docref_C11_MinMax}
\newpage
\input{docref_C11_ExperimentPlanes}
\newpage
\input{docref_C11_OptimizationAlgo}
\newpage
\input{docref_C211_QuadraticCumul}
\newpage
\input{docref_C221_MonteCarloStd}
\newpage
\input{docref_C311_TransIso}
\newpage
\input{docref_C311_TransIso_GeneralizedNataf}
\newpage
\input{docref_C311_TransIso_Rosenblatt}
\newpage
\input{docref_C311_Form}
\newpage
\input{docref_C311_Sorm}
\newpage
\input{docref_C311_ReliabilityIndex}
\newpage
\input{docref_C312_SampleSphere}
\newpage
\input{docref_C312_StrongMaxTest}
\newpage
\input{docref_C321_MonteCarloStd}
\newpage
\input{docref_C322_TI}
\newpage
\input{docref_C322_DirectionalSimulation}
\newpage
\input{docref_C322_LHS}
\newpage
\input{docref_C322_QuasiMonteCarlo}
\newpage
\input{docref_C41_MonteCarloStd}
\newpage

\extanchor{stepCprime}
...
OpenTURNS proposes ranking methods for two probabilistic criteria defined in the \otrefext{OpenTURNS_GlobalMethodology}{global methodology guide}: probabilist criterion on central dispersion (expectation and variance), probability of exceeding a threshold / failure probability.
...
\item \otref{docref_Cprime212_ANCOVA}{Sensivity analysis for models with correlated inputs}  -- see page \pageref{docref_Cprime212_ANCOVA} \vspace{2mm}
\item \otref{docref_Cprime212_FAST}{Sensivity analysis by Fourier decomposition}  -- see page \pageref{docref_Cprime212_FAST} \vspace{2mm}
\end{itemize}
...
\input{docref_Cprime211_ImportanceFactor}
\newpage
\input{docref_Cprime212_Pearson}
\newpage
\input{docref_Cprime212_Spearman}
\newpage
\input{docref_Cprime212_SRC}
\newpage
\input{docref_Cprime212_PCC}
\newpage
\input{docref_Cprime212_PRCC}
\newpage
\input{docref_Cprime212_SobolIndices}
\newpage
\input{docref_Cprime212_ANCOVA}
\newpage
\input{docref_Cprime212_FAST}
\newpage
\input{docref_Cprime31_ImportanceFactor}
\newpage
\input{docref_Cprime31_SensitivityFactor}
\newpage

\extanchor{responseSurface}
...
\begin{itemize}
\item \otref{docref_SurfRep_Kriging}{Kriging}
\end{itemize}
...
\input{docref_SurfRep_Taylor}
\newpage
\input{docref_SurfRep_NumMethLS}
\newpage
\input{docref_SurfRep_LSPolynomial}
\newpage
\input{docref_SurfRep_SparseLSPolynomial}
\newpage
\input{docref_SurfRep_Kriging}
\newpage
\input{docref_SurfRep_CrossValid}
\newpage
\input{docref_SurfRep_FunctionalChaos}
\newpage
\input{docref_SurfRep_OrthoPoly}
\newpage
\input{docref_SurfRep_PCBasis}
\newpage
\input{docref_SurfRep_Enum}
\newpage
\input{docref_SurfRep_PCTrunc}
\newpage
\input{docref_SurfRep_IntegLeastSquare}
% \newpage
